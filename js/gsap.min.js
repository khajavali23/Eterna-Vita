...
!(function (t, e) {
    ...
    function za(t, e) {
        ...
        return (
            r &&
                ...
                t._ts &&
                ((t._start = ca(
                    r._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)
                )),
                ya(t),
                r._dirty || sa(r, t)),
            t
    ...
    function Aa(t, e) {
        ...
        if (
            ((e._time || (e._initted && !e._dur)) &&
                ((r = xa(t.rawTime(), e)), (!e._dur || Tt(0, e.totalDuration(), r) - e._tTime > U) && e.render(r, !0)),
    ...
    function Da(t, e, r, i) {
        return (
            Ut(t, e),
            t._initted
                ? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== St.frame
    ...
    var Rt,
        ...
        Nt =
            ...
            (Rt.totalTime = function totalTime(t, e) {
                ...
                if (r && r.smoothChildTiming && this._ts) {
                    for (za(this, t), !r._dp || r.parent || Aa(r, this); r.parent; )
                        r.parent._time !==
                            r._start + (0 <= r._ts ? r._tTime / r._ts : (r.totalDuration() - r._tTime) / -r._ts) &&
            ...
            (Rt.progress = function progress(t, e) {
                return arguments.length
                    ? this.totalTime(this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + va(this), e)
                    : this.duration()
            ...
            (Rt.isActive = function isActive() {
                ...
                return !(
                    e &&
                    !(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - U)
                );
            }),
    ...
    var qt = (function (n) {
        ...
        return (
            ...
            (e.staggerFromTo = function staggerFromTo(e, r, i, n, a, s, o, u) {
                return (
                    (n.startAt = i), (na(n).immediateRender = t(n.immediateRender)), this.staggerTo(e, r, n, a, s, o, u)
                );
            }),
            (e.render = function render(t, e, r) {
                ...
                if (v !== this._tTime || r || y) {
                    ...
                    if (
                        ...
                        (this._act = !l),
                        this._initted ||
                            ((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = t), (_ = 0)),
        ...
        Xt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
            ...
            if (
                (o(i) &&
                    ...
                    "=" === i.charAt(1) &&
                        ((!(l =
                            parseFloat(d) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (Pa(d) || 0)) &&
                            0 !== l) ||
                            (i = l))),
                d !== i)
            )
                return isNaN(d * i) || "" === i
                    ...
                    : ((l = new ae(this._pt, t, e, +d || 0, i - (d || 0), "boolean" == typeof f ? Ht : Zt, 0, c)),
                      h && (l.fp = h),
            ...
            if (
                ...
                for (e._pt = 0, T = (C && t(T)) || (T && !C), n = 0; n < D.length; n++) {
                    ...
                    e._op && e._op[n] && e.kill(o, e._op[n]),
                        E && e._pt && ((Yt = e), R.killTweensOf(o, d, e.globalTime(0)), (m = !e.parent), (Yt = 0)),
                        e._pt && T && (lt[h.id] = 1);
                }
    ...
    function ud(e) {
        ...
        return (
            ...
            !r || r.width || r.x || r.y
                ? r
                : { x: +td(e, ["x", "cx", "x1"]) || 0, y: +td(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 }
        );
    }
    function vd(t) {
    ...
    function Ad(t, e, r, i) {
        ...
        return (
            ...
            Ie[e] && "transform" !== e
                ? ((n = $e(t, i)),
                  (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Je(od(t, Xe)) + " " + n.zOrigin + "px"))
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll('#menu a').forEach(link => {
    ...
    if (linkPage === currentPage) {
      ...
      // If inside submenu → also activate parent menu
