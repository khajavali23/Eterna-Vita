    ...
    class fe extends W {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    K.next(this._element, re)[0] || K.prev(this._element, re)[0] || K.findOne(re, this._parent)),
        ...
        _selectMenuItem({ key: t, target: e }) {
            const i = K.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t) =>
                h(t)
            );
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ("click" === e)
                    ...
                    const t =
                            e === Si ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
                        i =
                            e === Si
                    ...
                    j.on(this._element, t, this._config.selector, (t) => {
                        ...
                        j.on(this._element, i, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger["focusout" === t.type ? Li : Si] = e._element.contains(t.relatedTarget)),
                                e._leave();
                        });
                }
