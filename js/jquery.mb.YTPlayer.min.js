...
!(function (jQuery, ytp) {
    (jQuery.mbYTPlayer = {
        ...
        togglePlay: function (e) {
            let r = this.get(0);
            return r.isReady
                ? (1 === r.state ? this.YTPPause() : this.YTPPlay(), "function" == typeof e && e(r.state), this)
                : this;
        },
        stop: function () {
            let e = this.get(0);
        ...
        pause: function () {
            let e = this.get(0);
            return e.isReady
                ? (e.opt.abundance < 0.2 && this.YTPSetAbundance(0.2), e.player.pauseVideo(), (e.state = 2), this)
                : this;
        },
        seekTo: function (e) {
            let r = this.get(0);
        ...
        changeCoverImage: function (e) {
            ...
            if (r.opt.coverImage || r.orig_containment_background) {
                let t =
                    e ||
                    (r.opt.coverImage ? "url(" + r.opt.coverImage + ") center center" : r.orig_containment_background);
                t &&
            ...
            jQuery.mbYTPlayer.checkForStart(YTPlayer),
                (YTPlayer.getState = setInterval(function () {
                    ...
                    if (
                        ...
                        e || 1 != YTPlayer.state
                            ? e && !YTPlayer.isOnScreen && ((YTPlayer.isOnScreen = !0), YTPlayer.player.playVideo())
